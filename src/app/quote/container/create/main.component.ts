...
export class QuoteComponent implements OnInit {
  ...
  constructor(public administrationService: AdministrationService,
    ...
    this.evaluateForm = this.formBuilder.group({
      ...
      understanding_score: new FormControl('', Validators.compose([Validators.required,])),
      understanding_remarks: new FormControl('', Validators.compose([Validators.required,])),
      achievement_score: new FormControl('', Validators.compose([Validators.required,])),
      achievement_remarks: new FormControl('', Validators.compose([Validators.required,])),
      innovation_score: new FormControl('', Validators.compose([Validators.required,])),
      innovation_remarks: new FormControl('', Validators.compose([Validators.required,])),
      paradigm_score: new FormControl('', Validators.compose([Validators.required,])),
      paradigm_remarks: new FormControl('', Validators.compose([Validators.required,])),
      challenges_score: new FormControl('', Validators.compose([Validators.required,])),
      challenges_remarks: new FormControl('', Validators.compose([Validators.required,])),
      sustainability_score: new FormControl('', Validators.compose([Validators.required,])),
      sustainability_remarks: new FormControl('', Validators.compose([Validators.required,])),
      stakeholders_score: new FormControl('', Validators.compose([Validators.required,])),
      stakeholders_remarks: new FormControl('', Validators.compose([Validators.required,])),
      pictorial_score: new FormControl('', Validators.compose([Validators.required,])),
      pictorial_remarks: new FormControl('', Validators.compose([Validators.required,])),
      reporting_score: new FormControl('', Validators.compose([Validators.required,])),
      reporting_remarks: new FormControl('', Validators.compose([Validators.required,])),
      impact_score: new FormControl('', Validators.compose([Validators.required,])),
      impact_remarks: new FormControl('', Validators.compose([Validators.required,])),
      budget_score: new FormControl('', Validators.compose([Validators.required,])),
      budget_remarks: new FormControl('', Validators.compose([Validators.required,])),
  ...
  save_evaluation() {
    const payload = {
      'data': this.create_obj(),
      'rri_goal': this.evaluateForm.get('rri_goal')!.value,
    }
