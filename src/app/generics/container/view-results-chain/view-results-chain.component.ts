...
@Component({
  selector: 'app-view-results-chain',
  templateUrl: './view-results-chain.component.html',
  styleUrls: ['./view-results-chain.component.scss']
})

export class ViewResultsChainComponent implements OnInit {
