...
export class SubCountyComponent implements OnInit {
  ...
  constructor(public administrationService: AdministrationService,
    ...
    this.createRecordForm = this.formBuilder.group({
      ...
      borough: new FormControl('', Validators.compose([Validators.required, Validators.minLength(2), ])),
    });
  ...
  fetchBoroughs() {
    ...
    this.administrationService.getrecords(boroughs_url, params).subscribe((res) => {
      this.boroughs = res;
      // this.loadingService.hideloading();
