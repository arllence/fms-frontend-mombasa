...
export class TitleComponent implements OnInit {
  ...
  editRecord(objectinstance:any) {
    ...
    this.administrationService.getrecords(title_url, filter_params).subscribe((res:any) => {
      const forminstance = {
        'id': res['id'],
        'name': res['name'],
    ...
    if (this.createRecordForm.invalid) {
      ...
      this.sweetalertService.showConfirmation('Confirmation', 'Do you wish to proceed creating record?').then((res) => {
        if (res) {
          ...
          this.administrationService.postrecord(title_url, payload).subscribe((data) => {
            if (data) {
              this.fetchRecords();
    ...
    if (this.editRecordForm.invalid) {
      ...
      'Do you wish to proceed updating record?').then((res) => {
        if (res) {
          ...
          this.administrationService.updaterecord(title_url, payload).subscribe((data) => {
            if (data) {
              this.fetchRecords();
